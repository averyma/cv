\section*{Publications}
    ...
    \begin{adjustwidth}{\indentleft}{\indentright}
        \begin{itemize}
            ...
            \item \textbf{Ma, A.}, Wong, A.,Clausi, D.A. (2018). Deep learning-driven depth from defocus via active multispectral quasi-random projections with complex subpatterns*. In: \emph{CRV'18: Conference on Computer and Robot Vision}.
